...
**`docs/` describes.** What the system is, why the model is shaped this way, and how to author content. Read by a person, outside a session.
...
The agent never reads pack files. That is what keeps a session cheap.
